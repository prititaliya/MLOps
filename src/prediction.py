...
class ModelPredictor:
    def __init__(self, model_path="/Users/jatin/Desktop/MLOps/pipelines/model/xgboost_model.pkl"):
...
def main():
    ...
    if preprocessed_data is not None:
        ...
        if predictions is not None:
            ...
            encoder_path = Path("/Users/jatin/Desktop/MLOps/pipelines/model/label_encoder.pkl")
